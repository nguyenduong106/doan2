...
class TaskItem extends Component {
  ...
  render(){ 
    return (
      ...
      <td className='text-center'>{this.props.task.container}</td>
      <td className='text-center'>{this.props.task.name}</td>
    <td className='text-center'>{this.props.task.vehicleType!==undefined?this.props.task.vehicleType.name:'No Data'}</td>     
